...
class ReadablebotmateQuery extends Readable {
  /**
   * @param {object} options
   * @param {ReturnType<typeof import('../../query-builder')>} options.qb The botmate query builder instance
...
module.exports = ReadablebotmateQuery;
