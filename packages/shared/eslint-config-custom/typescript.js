...
module.exports = {
  root: true,
  extends: [
    '@botmate/eslint-config/typescript' /*'plugin:@typescript-eslint/recommended-requiring-type-checking'*/,
  ],
  ...
  rules: {
    ...
    // TODO: The following rules from @botmate/eslint-config/typescript are disabled because they're causing problems we need to solve or fix
