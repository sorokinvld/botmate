...
export const BotMateLogo = ({ height, width, color = '#FFFFFF' }: LogoProps) => (
  <chakra.svg
    width={width}
    height={height}
    viewBox="0 0 512 512"
  ...
  >
    <chakra.title>botmate-logo-dark</chakra.title>
    <chakra.g id="botmate-logo-dark" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <chakra.path
